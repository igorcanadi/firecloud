...
print 'Cheating? {0} {1}'.format(d0['parted'], d0['parted'] == d1['parted'])
print 'Quick healing? {0} {1}'.format(d0['joint'], d0['joint'] == d1['joint'])
print 'Slow healing? {0} {1}'.format(d0['joint2'], d0['joint2'] == d1['joint2'])
